...
/**
 * Example component showcasing the OrganizationInvitationTemplate email
...
const ExampleOrganizationInvitationEmail = () =>
  React.createElement(OrganizationInvitationTemplate, testData.organizationInvitation) as React.ReactElement;
