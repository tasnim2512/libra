/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: ed51b9d4a6f65bf683b1a6e98c374941)
// Runtime types generated with workerd@1.20250712.0 2025-07-23 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		CACHE: KVNamespace;
		NEXT_CACHE_DO_QUEUE: DurableObjectNamespace /* DOQueueHandler from opennext-cache */;
		NEXT_TAG_CACHE_DO_SHARDED: DurableObjectNamespace /* DOShardedTagCache from opennext-cache */;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		DATABASE: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* libra */;
